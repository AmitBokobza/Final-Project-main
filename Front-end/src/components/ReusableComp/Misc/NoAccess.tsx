...
const NoAccess: FunctionComponent<NoAccessProps> = () => {
    ...
    return ( 
        <>
        <div className={`container mx-auto px-4 py-16 flex items-center justify-center min-h-[60vh] ${theme === "dark" ? "bg-dark" : "bg-light"}`}>
      <div className="card text-center p-8 rounded-lg shadow-lg relative max-w-md w-full">
        <div className="absolute top-0 left-0 w-full h-1 gradient-background" />
        
        <svg
          className="w-16 h-16 secondary-text mx-auto mb-4"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
